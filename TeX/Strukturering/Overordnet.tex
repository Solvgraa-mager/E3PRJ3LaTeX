...
\Portbeskrivelse{Inout SumoKom}{Wifi}{Tovejskommunikation med Central Computer hvor der modtages information omkring retning og hastighed og sendes information om et evt. angreb}{
\item 
\item 
}
\Portbeskrivelse{In RobotAngreb}{Force}{Fysisk påvirkning fra anden SumoBot, der registreres som et attack}{
\item 
\item 
}
\Portbeskrivelse{Out motorDrive}{torque}{Skaber fremdrift til SumoBotten}{
\item 
\item 
}
\end{BlokDescription}
